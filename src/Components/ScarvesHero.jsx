...
import hero from '../assets/scarves/s11.jpg'

function ScarvesHero() {
  return (
    <>
    <div className='flex flex-col w-full h-90 mt-5 sm:px-40 px-4'>
        <h2 className='text-4xl py-4 font-bold'>PATTERNS THAT DEFINE CULTURES</h2>
